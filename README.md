...
### Тестирование db роли
 ...
 - Установил приложения и зависимости 
 - Использовал команду molecule init для создания заготовки тестов для роли db.
 - Создал тестовую машины при помощи Molecule для тестировани
 - Создал и протестировал роль converge которая применяется к тестовой VM.
 - Написал тест к роли db для проверки того, что БД слушает по нужному порту
